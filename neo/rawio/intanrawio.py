    ...
    * Due to the structure of the digital input and output channels these can be accessed
    ...
    def _parse_header(self):
        ...
        if self.filename.endswith(".rhs"):
            ...
            self._global_info, self._ordered_channels, self._event_channels, data_dtype, header_size, self._block_size = read_rhs(
                self.filename
            )
...
def read_rhd(filename, file_format: str):
    ...
    return global_info, ordered_channels, event_channels, data_dtype, header_size, BLOCK_SIZE, channel_number_dict
